...
namespace ProyectoATECA.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_servicio,nombre")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_servicio,nombre")] Servicio servicio)
        {
            if (ModelState.IsValid)
            {
